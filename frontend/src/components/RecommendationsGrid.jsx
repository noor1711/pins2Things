...
const RecommendationGrid = ({ itemGroups }) => {
  ...
  return (
    <div className="w-full max-w-6xl mx-auto p-4 md:p-6" aria-live="polite">
      <div className="mb-6">
        <h2 className="text-5xl md:text-3xl lg:text-4xl font-bold text-emerald-700">
          Recommendations
        </h2>
        <p className="text-sm text-neutral-400">
      ...
      {itemGroups.map((group) => {
        ...
        return (
          <>
            <h3 className="text-3xl text-center md:text-3xl lg:text-4xl font-bold text-emerald-600 text-transform-capitalize mt-7 mb-3">
              {description}
            </h3>
